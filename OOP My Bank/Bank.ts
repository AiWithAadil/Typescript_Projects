...
class Bank {
    ...
    constructor(accountNum: number, initialBalance: number = 0, withdrawalCharge: number = 0, depositCharge: number = 0) {
...
async function CustomerInfo() {
    const info = await inquirer.prompt([
        ...
        },
        {
            ...
            validate: (value: any) => !isNaN(value) && value > 0 ? true : 'Please enter a valid age.'
        },
        {
            type: 'input',
            name: 'gender',
        ...
        },
        {
            ...
            validate: (value: any) => !isNaN(value) && value > 0 ? true : 'Please enter a valid mobile number.'
        },
        {
            type: 'input',
            name: 'accNum',
            message: 'Enter your account number',
            validate: (value: any) => !isNaN(value) && value > 0 ? true : 'Please enter a valid account number.'
        },
        {
            type: 'input',
            name: 'initialBalance',
            message: 'Enter the initial balance for the account',
            validate: (value: any) => !isNaN(value) && value >= 0 ? true : 'Please enter a valid balance.'
        }
    ]);
